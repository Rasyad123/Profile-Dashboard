...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-full flex justify-center items-center transform scale-100 origin-center overflow-visible">
      <Canvas
        camera={{ position, fov }}
...
function Band({
  ...
  // Proportional scale to match text size nicely (3.5x scale)
  const CARD_SCALE = 3.5;
  const S = CARD_SCALE / 2.25;
